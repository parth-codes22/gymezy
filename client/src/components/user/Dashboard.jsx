    ...
    {location.pathname === "/user/dashboard" || location.pathname === "/user/dashboard/" ? (
      <><div className="hidden sm:block"><div className="w-full h-full grid grid-cols-2 gap-5 md:gap-10 p-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
        <Card className="py-4 w-[80%] hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none" >
          <CardBody className="overflow-visible py-2 flex md:flex-row" onClick={() => navigateTo("/user/dashboard/live")}>
            <Image
              alt="Card background"
            ...
            <div className="pb-0 pt-2 px-4 h-full flex flex-col justify-center items-start">
              ...
              <h4 className="font-bold text-large">Live Tracking</h4>
            </div>
        ...
        <Card className="py-4 w-[80%] hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex md:flex-row" onClick={() => navigateTo("/user/dashboard/checkin")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={CheckIn}
            ...
            <div className="pb-0 pt-2 px-4 h-full flex flex-col justify-center items-start">
              <p className="text-tiny uppercase font-bold">Daily Mix</p>
              <small className="text-default-500">12 Tracks</small>
              <h4 className="font-bold text-large">Check In</h4>
            </div>
            <div className="absolute bottom-0 left-0 w-full md:top-0 md:right-0 md:left-auto font-black md:h-full md:w-3 flex justify-center items-center rounded-full p-1 opacity-0 group-hover:opacity-100 group-hover:bg-green-600 transition-all">&gt;</div>
          </CardBody>
        </Card>
        <Card className="py-4 w-[80%] hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex md:flex-row" onClick={() => navigateTo("/user/dashboard/history")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={History}
            ...
            <div className="pb-0 pt-2 px-4 h-full flex flex-col justify-center items-start">
              <p className="text-tiny uppercase font-bold">Daily Mix</p>
              <small className="text-default-500">12 Tracks</small>
              <h4 className="font-bold text-large">History</h4>
            </div>
            <div className="absolute bottom-0 left-0 w-full md:top-0 md:right-0 md:left-auto font-black md:h-full md:w-3 flex justify-center items-center rounded-full p-1 opacity-0 group-hover:opacity-100 group-hover:bg-green-600 transition-all">&gt;</div>
          </CardBody>
        </Card>
        <Card className="py-4 w-[80%] hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex md:flex-row" onClick={() => navigateTo("/user/dashboard/membership")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={Membership}
            ...
            <div className="pb-0 pt-2 px-4 h-full flex flex-col justify-center items-start">
              <p className="text-tiny uppercase font-bold">Daily Mix</p>
              <small className="text-default-500">12 Tracks</small>
              <h4 className="font-bold text-large">Manage Membership</h4>
            </div>
            <div className="absolute bottom-0 left-0 w-full md:top-0 md:right-0 md:left-auto font-black md:h-full md:w-3 flex justify-center items-center rounded-full p-1 opacity-0 group-hover:opacity-100 group-hover:bg-green-600 transition-all">&gt;</div>
          </CardBody>
        </Card>
      ...
      <div className="sm:hidden flex flex-col gap-5 p-5">
        <Card className="p-2 w-full hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex flex-row" onClick={() => navigateTo("/user/dashboard/live")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={Tracking}
        ...
        <Card className="p-2 w-full hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex flex-row" onClick={() => navigateTo("/user/dashboard/checkin")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={CheckIn}
        ...
        <Card className="p-2 w-full hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex flex-row" onClick={() => navigateTo("/user/dashboard/history")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={History}
        ...
        <Card className="p-2 w-full hover:scale-110 transition-all relative group bg-slate-200 dark:bg-slate-800 cursor-pointer select-none">
          <CardBody className="overflow-visible py-2 flex flex-row" onClick={() => navigateTo("/user/dashboard/membership")}>
            <Image
              alt="Card background"
              className="object-fit rounded-xl p-10 px-5"
              src={Membership}
