...
// const socket = io('https://gymezy-backend.vercel.app/', { transports: ['websocket'] });
...
//   useEffect(() => {
//     fetch('https://gymezy-backend.vercel.app/get_occupancy')
//       .then(res => res.json())
//       .then(data => updateData(data));

//     socket.on('update', (data) => {
//       updateData(data.machines);
//     });
...
//     setMachineData(prev => ({ ...prev, ...transformedData }));
//   };
...
//                 {details.totalAvailable !== 0 ? (<Chip color="success" variant="dot">Available</Chip>) : (<Chip color="danger" variant="dot">Occupied</Chip>)}
//               </div>
//             </CardBody>
//           </Card>
//         ))}
